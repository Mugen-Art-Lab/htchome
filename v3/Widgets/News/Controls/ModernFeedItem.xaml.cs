...
namespace News.Controls
{
    ...
    /// </summary>
    public partial class ModernFeedItem : UserControl
    {
        ...
        public int Order
        {
            ...
            {
                order = value;
                ScaleAnim.BeginTime = TimeSpan.FromMilliseconds(550 + 200 * value);
                OpacityAnim.BeginTime = TimeSpan.FromMilliseconds(550 + 200 * value);
            }
        }
