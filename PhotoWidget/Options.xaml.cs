...
namespace PhotoWidget
{
    ...
    public partial class Options : Window
    {
        ...
        private void Window_SourceInitialized(object sender, EventArgs e)
        {
            ...
            SwitchAutomaticallyCheckBox.IsChecked = Widget.Instance.Sett.SwitchAutomatically;
            IntervalComboBox.Text = Widget.Instance.Sett.Interval.ToString();
            PicsPathBox.Text = Widget.Instance.Sett.PicsPath;

            UiModeComboBox.SelectedIndex = Widget.Instance.Sett.Mode;
        ...
        {
            bool rescan = Widget.Instance.Sett.PicsPath != PicsPathBox.Text;

            Widget.Instance.Sett.Interval = Convert.ToInt32(IntervalComboBox.Text); ;
            Widget.Instance.Sett.SwitchAutomatically = (bool)SwitchAutomaticallyCheckBox.IsChecked;
            Widget.Instance.Sett.PicsPath = PicsPathBox.Text;
            Widget.Instance.Sett.Mode = UiModeComboBox.SelectedIndex;

            Widget.Instance.Sett.Write(HTCHome.Core.Environment.ConfigDirectory + "\\PhotoWidget.conf");
